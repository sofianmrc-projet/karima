...
namespace Karima.Api.Migrations
{
    ...
    [Migration("20250916215550_AddUserAndContentManagementV2")]
    partial class AddUserAndContentManagementV2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Karima.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsAdmin = true,
                            LastName = "Karima",
                            PasswordHash = "$2a$11$F/OyPK1nNdmPljsaOChupO6.yNmRQHbsUq6CYf9cTYOYzDY/LPEqO"
                        });
                });
